...
spark = SparkSession \
        .builder \
        .appName('save_as_table_postings') \
        .enableHiveSupport() \
        .getOrCreate()
...
# dataframe saveAsTable (default format: parquet)
postings_df.write \
            .saveAsTable('postings',
                         mode='overwrite',
                         path=postings_path)
print(f'postings_df 저장 완료: /user/hive/warehouse/linkedIn/postings')